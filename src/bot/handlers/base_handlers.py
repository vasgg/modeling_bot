...
from bot.keyboards import ModelMenuOption, UploadPhotoOption, get_accept_button, get_model_kb, \
    get_photo_buttons, get_photo_requirements_buttons, \
    get_rejected_photo_buttons, get_requirements_kb
